...
import { Bookmark, FlagTriangleRight, MoreHorizontal, Pencil, Trash, Users } from "lucide-react";
              ...
              <div className="p-5 pb-3">
                <div className="flex justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    >
                      <DropdownMenuItem className="items-start gap-3 text-left pr-5">
                        <Bookmark className="mt-1" size={23} />
                        <div className="">
                          <h2 className="text-base">Save post</h2>
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem className="items-start gap-3 text-left text-base pr-5">
                        <Pencil className="mt-1" size={23} />
                        <h2 className="text-base">Edit post</h2>
                      </DropdownMenuItem>
                      <DropdownMenuItem className="items-start gap-3 text-left pr-5 group">
                        <Trash className="mt-1 group-hover:text-rd transition-colors ease-in-out duration-100" size={23} />
                        <div className="">
                          <h2 className="text-base group-hover:text-rd transition-colors ease-in-out duration-100">Delete post</h2>
                          <p className="text-sm font-light text-subtle">
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem className="items-start gap-3 text-left pr-5 group">
                        <FlagTriangleRight className="mt-1 group-hover:text-rd transition-colors ease-in-out duration-100" size={23} />
                        <div className="">
                          <h2 className="text-base group-hover:text-rd transition-colors ease-in-out duration-100">Report post</h2>
                          <p className="text-sm font-light text-subtle">
